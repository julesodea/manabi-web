    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 bg-card-bg border-t border-gray-200 z-50 pb-safe">
        <div className="grid grid-cols-5 h-20 px-2">
          <Link
            href="/"
            className="flex flex-col items-center justify-center gap-1.5 text-muted hover:text-accent transition-colors"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          <button className="flex flex-col items-center justify-center relative">
            <Link
              ...
              className="absolute -top-6 w-14 h-14 rounded-full flex items-center justify-center bg-accent"
            >
              <svg
                className="w-8 h-8 text-accent-text"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <Link
            href="/settings"
            className="flex flex-col items-center justify-center gap-1.5 text-accent"
          >
            <svg
              className="w-6 h-6"
              fill="none"
